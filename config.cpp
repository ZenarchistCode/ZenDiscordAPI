...
class CfgVehicles
{
	...
	//! GENERIC KIT BOX 
	class ZenKitBoxBase_RaidAlarm : Inventory_Base
	{
		scope = 0;
		...
		hiddenSelections[] = { "texture" };
		hiddenSelectionsTextures[] = { "ZenDiscordAPI\data\textures\zenkitbox\kit_blank_co.paa" };
		weight = 10000;
		itemSize[] = { 9,5 };
		physLayer = "item_small";
		itemBehaviour = 0;
	...
	class Zen_RaidAlarmRadarKit : ZenKitBoxBase_RaidAlarm
	{
		scope = 2;
