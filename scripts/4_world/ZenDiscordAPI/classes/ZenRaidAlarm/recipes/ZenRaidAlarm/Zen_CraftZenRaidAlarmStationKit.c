class Zen_CraftZenRaidAlarmStationKit extends RecipeBase
{
	override void Init()
	{
		int recipeMakeCost = 50;
		int recipeResourceCost = 10;
		string makeItem = "Nail";
		string resourceItem = "WoodenPlank";
		string resultItem = "Zen_RaidAlarmStationKit";

		m_Name = "#craft #STR_CfgVehicles_ZenRaidAlarmStation0";	// action name in game
		...
		//result
		AddResult(resultItem);	// recipe result
